using CareerBlazer.Shared.Models;
...
namespace CareerBlazer.Client.Services
{
    public class DashboardDataService
    {
        ...
        {
            return await Http.GetFromJsonAsync<IEnumerable<PodcastViewModel>>("PodcastData/AllPodcasts");
        }
        ...
        {
            return await Http.GetFromJsonAsync<IEnumerable<PlatformViewModel>>("PodcastData/PlatformData?byDevice=" + byDevice);
        }
    }
}
